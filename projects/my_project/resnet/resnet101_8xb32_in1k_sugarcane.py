...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='/home/ypx/project/ljn/mmpretrain/dataset/Sugarcane Leaf Image Dataset',
        pipeline=train_pipeline,
        data_prefix='img',
        classes=['Banded Chlorosis', 'Brown Spot', 'BrownRust', 'Dried Leaves', 'Grassy shoot', 'Healthy Leaves', 'Pokkah Boeng', 'Sett Rot', 'Viral Disease', 'Yellow Leaf', 'smut'],
