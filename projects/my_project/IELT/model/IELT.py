...
class InterEnsembleLearningTransformer(BaseBackbone):
    """Vision Transformer.
    ...
    def __init__(self,
                 ...
                 pre_norm=False,
                 init_cfg=None):
        super(InterEnsembleLearningTransformer, self).__init__(init_cfg)
    ...
    def init_weights(self):
        super(InterEnsembleLearningTransformer, self).init_weights()
